...
const RemixImage: React.FC<{ setCurrentPage: (page: Page) => void }> = ({ setCurrentPage }) => {
  ...
  }, [files, prompt, remixCount, aspectRatio, highQuality, imageSize, addJobs, setCurrentPage]);
